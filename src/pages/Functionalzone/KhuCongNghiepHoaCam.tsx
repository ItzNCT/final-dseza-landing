          ...
          <div className="px-4 py-2 space-y-3">
            ...
            <div className={`text-sm font-inter ${theme === 'dark' ? 'text-dseza-dark-secondary-text' : 'text-dseza-light-secondary-text'}`}>
                ...
                <div className="space-y-4 text-justify">
                    <section>
                        <h2 className={`font-montserrat text-base font-bold mb-2 ${theme === 'dark' ? 'text-dseza-dark-primary' : 'text-dseza-light-primary'}`}>1. Vị trí địa lý</h2>
                        <p className="mb-2">quận Cẩm Lệ, thành phố Đà Nẵng.</p>
                    ...
                    <section>
                        <h2 className={`font-montserrat text-base font-bold mb-2 ${theme === 'dark' ? 'text-dseza-dark-primary' : 'text-dseza-light-primary'}`}>3. Giá cho thuê lại đất và tiền sử dụng hạ tầng: (Đến tháng 8 năm 2054)</h2>
                        <p className="text-xs italic mb-2">Ngày cập nhật: 05/2020</p>
                        <p className="text-xs italic mb-3">Giá có tính chất tham khảo, mọi chi tiết xin liên hệ Công ty Cổ phần Đầu tư Khu công nghiệp Hòa Cầm (HoacamIZI)</p>
                        <div className="mt-3">
                                ...
                                <table className={`min-w-full border-collapse border text-xs ${theme === 'dark' ? 'border-dseza-dark-border' : 'border-dseza-light-border'}`}>
                                    ...
                                    <tbody className={`${theme === 'dark' ? 'text-dseza-dark-secondary-text' : 'text-dseza-light-secondary-text'}`}>
                                        <tr className={`${theme === 'dark' ? 'bg-dseza-dark-main-bg' : 'bg-dseza-light-main-bg'}`}>
                                            <td className={`p-2 border ${theme === 'dark' ? 'border-dseza-dark-border' : 'border-dseza-light-border'}`}>Trả tiền thuê lại đất hàng năm</td>
                                            <td className={`p-2 border ${theme === 'dark' ? 'border-dseza-dark-border' : 'border-dseza-light-border'}`}>80.000</td>
                                        </tr>
                                        <tr className={`${theme === 'dark' ? 'bg-dseza-dark-secondary-bg' : 'bg-dseza-light-secondary-bg'}`}>
                                            <td className={`p-2 border ${theme === 'dark' ? 'border-dseza-dark-border' : 'border-dseza-light-border'}`}>Trả tiền thuê lại đất một lần cho toàn bộ thời hạn thuê (đến ngày 08/8/2054)</td>
                                            <td className={`p-2 border ${theme === 'dark' ? 'border-dseza-dark-border' : 'border-dseza-light-border'}`}>2.150.000 (đồng/m2/toàn bộ thời hạn thuê)</td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                        ...
                        <div className="mt-4">
                            <h3 className={`font-montserrat text-sm font-semibold mb-2 ${theme === 'dark' ? 'text-dseza-dark-main-text' : 'text-dseza-light-main-text'}`}>- Đơn giá tiền sử dụng hạ tầng:</h3>
                            <p className="mb-1">14.950 đồng/m2/năm (trả hàng năm)</p>
                            <p className="text-xs italic">Các đơn giá nêu trên chưa bao gồm thuế GTGT</p>
                        </div>
                    </section>
                    <section>
                        ...
                        <p className="font-semibold mb-2">Công ty Cổ phần đầu tư KCN Hòa Cầm (Hoa Cam IZI).</p>
                    ...
                    <section>
                        <h2 className={`font-montserrat text-base font-bold mb-2 ${theme === 'dark' ? 'text-dseza-dark-primary' : 'text-dseza-light-primary'}`}>6. Bản đồ quy hoạch KCN Hòa Cầm</h2>
